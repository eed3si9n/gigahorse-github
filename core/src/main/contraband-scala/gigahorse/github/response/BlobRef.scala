...
final class BlobRef private (
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (17 + "gigahorse.github.response.BlobRef".##) + url.##) + sha.##) + name.##) + path.##) + repository.##) + git_url.##) + html_url.##)
  }
...
object BlobRef {
  ...
  def apply(url: String, sha: String, name: String, path: String, repository: gigahorse.github.response.Repo): BlobRef = new BlobRef(url, sha, name, path, repository)
