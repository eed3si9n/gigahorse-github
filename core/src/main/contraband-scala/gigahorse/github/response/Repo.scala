...
final class Repo private (
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (17 + "Repo".##) + url.##) + name.##) + id.##) + owner.##) + full_name.##) + description.##) + `private`.##) + fork.##) + html_url.##) + clone_url.##) + git_url.##) + ssh_url.##) + homepage.##) + language.##) + forks_count.##) + watchers_count.##) + size.##) + default_branch.##) + open_issues_count.##) + pushed_at.##) + created_at.##) + updated_at.##)
  }
...
object Repo {
  ...
  def apply(url: String, name: String, id: Long, owner: gigahorse.github.response.User, full_name: String, description: String, `private`: Boolean, fork: Boolean): Repo = new Repo(url, name, id, owner, full_name, Option(description), `private`, fork, None, None, None, None, None, None, None, None, None, None, None, None, None, None)
