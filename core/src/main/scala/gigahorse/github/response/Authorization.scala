...
final class Authorization(
  ...
  def this(url: String, id: Long, scopes: Vector[String], token: String, token_last_eight: String, hashed_token: String) = this(url, id, scopes, token, token_last_eight, hashed_token, None, None, None, None)
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (17 + url.##) + id.##) + scopes.##) + token.##) + token_last_eight.##) + hashed_token.##) + note.##) + note_url.##) + created_at.##) + updated_at.##)
  }
